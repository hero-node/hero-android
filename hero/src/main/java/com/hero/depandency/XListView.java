...
public class XListView extends ListView implements OnScrollListener, XListViewHeader.OnStopListener {

    private final static int SCROLLBACK_HEADER = 0;
    private final static int SCROLLBACK_FOOTER = 1;
    private final static int SCROLL_DURATION = IRefreshHeader.SCROLL_DURATION; // scroll back duration
    ...
    protected View mHeaderViewContent;
    ...
    protected void addHeaderView(Context context) {
        ...
        mHeaderView.setOnStopListener(this);
    }
        ...
        if (!mEnablePullLoad) {
            ...
            mFooterView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mFooterView.getState() != XListViewFooter.STATE_NO_DATA) {
                        startLoadMore();
                    }
                }
            });
    ...
    public void stopRefresh() {
        mHeaderView.setState(XListViewHeader.STATE_REFRESH_STOPPED);
    }
        ...
        switch (ev.getAction()) {
            ...
            default:
                ...
                if (getFirstVisiblePosition() == 0) {
                    // invoke refresh
                    if (!mPullRefreshing && mEnablePullRefresh && mHeaderView.getVisibleHeight() > mHeaderViewHeight) {
                ...
                if (getLastVisiblePosition() == mTotalItemCount - 1) {
                    // invoke load more.
                    if (mEnablePullLoad && mFooterView.getBottomMargin() > PULL_LOAD_MORE_DELTA && !mPullLoading && !mPullRefreshing) {
                        if (mFooterView.getState() != XListViewFooter.STATE_NO_DATA) {
                            startLoadMore();
                        }
                    }
