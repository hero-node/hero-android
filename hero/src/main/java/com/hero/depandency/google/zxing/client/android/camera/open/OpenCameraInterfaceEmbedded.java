...
package com.hero.depandency.google.zxing.client.android.camera.open;

import android.hardware.Camera;
import android.util.Log;

public final class OpenCameraInterfaceEmbedded {

    private static final String TAG = OpenCameraInterfaceEmbedded.class.getName();

    private OpenCameraInterfaceEmbedded() {
    }
