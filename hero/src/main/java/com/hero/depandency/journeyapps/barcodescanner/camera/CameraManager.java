...
import com.hero.depandency.google.zxing.client.android.AmbientLightManager;
import com.hero.depandency.google.zxing.client.android.camera.CameraConfigurationUtils;
import com.hero.depandency.google.zxing.client.android.camera.open.OpenCameraInterfaceEmbedded;
import com.hero.depandency.journeyapps.barcodescanner.Size;
...
public final class CameraManager {
     ...
     */
    public void open() {
        camera = OpenCameraInterfaceEmbedded.open(settings.getRequestedCameraId());
        if (camera == null) {
            throw new RuntimeException("Failed to open camera");
        }

        int cameraId = OpenCameraInterfaceEmbedded.getCameraId(settings.getRequestedCameraId());
